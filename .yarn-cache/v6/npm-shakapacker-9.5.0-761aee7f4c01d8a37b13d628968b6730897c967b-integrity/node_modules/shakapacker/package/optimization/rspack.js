...
const getOptimization = () => {
    ...
    try {
        ...
        logError(`Failed to configure Rspack minimizers: ${errorMessage}\n${errorStack}`);
        // Re-throw the error to properly propagate it
        throw new Error(`Could not configure Rspack minimizers: ${errorMessage}. Please check that @rspack/core is properly installed.`);
    }
    return result;
};
module.exports = {
