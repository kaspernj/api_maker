 ...
 */
export declare const BUILD_ENV_VARS: readonly ["NODE_ENV", "RAILS_ENV", "NODE_OPTIONS", "BABEL_ENV", "WEBPACK_SERVE", "CLIENT_BUNDLE_ONLY", "SERVER_BUNDLE_ONLY"];
/**
 ...
 */
export declare const DANGEROUS_ENV_VARS: readonly ["PATH", "HOME", "LD_PRELOAD", "LD_LIBRARY_PATH", "DYLD_LIBRARY_PATH", "DYLD_INSERT_LIBRARIES"];
/**
 ...
 */
export declare function isBuildEnvVar(key: string): key is (typeof BUILD_ENV_VARS)[number];
/**
 ...
 * The assertion is safe because we're only widening the type for the includes() check.
 */
export declare function isDangerousEnvVar(key: string): key is (typeof DANGEROUS_ENV_VARS)[number];
/**
 * Default directory for config exports when using --doctor or file output modes.
 */
export declare const DEFAULT_EXPORT_DIR = "shakapacker-config-exports";
/**
 * Default config file path for bundler build configurations.
 */
export declare const DEFAULT_CONFIG_FILE = "config/shakapacker-builds.yml";
