const envFilter_1 = require("./envFilter");
...
const getPlugins = () => {
    ...
    const WebpackAssetsManifestConstructor = "WebpackAssetsManifest" in WebpackAssetsManifest
    ...
    const plugins = [
        ...
        new webpack.EnvironmentPlugin((0, envFilter_1.getFilteredEnv)()),
    ...
    if (config.integrity?.enabled &&
        ...
        const SubresourceIntegrityPlugin = requireOrError("webpack-subresource-integrity");
