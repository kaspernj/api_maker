...
private
  ...
  def copy_base_model
    files = %w[
      ...
      commands-pool.js devise.js event-destroyed.jsx event-emitter-listener.jsx event-listener.jsx error-logger.js form-data-to-object.js
      included.js logger.js model-name.js models-response-reader.js result.js event-connection.jsx paginate.jsx sort-link.jsx
