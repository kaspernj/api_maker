...
export default function RoutesUtilsGlobalRequestData() {
  ...
  useEffect(() => {
    ...
    Services.current().sendRequest("GlobalRequestDataTest", {}, {instant: true})
      .then((response) => setResult(response))
  }, [])

  return (
    <Layout className="routes-utils-global-request-data">
      <View>
