...
describe "api maker table - remove column no longer found" do
  let(:table_setting) { create :table_setting, identifier: "tasks-default", user: user }
  let(:table_setting_column_not_found) { create :table_setting_column, id: 99_982, identifier: "not-found", table_setting: table_setting }
