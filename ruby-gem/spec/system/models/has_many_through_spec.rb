...
describe "models - has many as" do
  ...
  let(:account_marked_task1) { create :account_marked_task, account: account, task: task1 }
  let(:account_marked_task2) { create :account_marked_task, account: account, task: task2 }
  let(:project) { create :project, account: account, id: 103 }
  let(:task1) { create :task, project: project, id: 104 }
  let(:task2) { create :task, project: project, id: 105 }
