...
export default class BaseModel {
  ...
  connect(eventName, callback) {
    var cableSubscription = CableConnectionPool.current().connectEvent(this.modelClassData().name, this.primaryKey(), eventName, callback)
  ...
  connectDestroyed(callback) {
    var cableSubscription = CableConnectionPool.current().connectDestroyed(this.modelClassData().name, this.primaryKey(), callback)
    return cableSubscription
  }

  connectUpdated(callback) {
    var cableSubscription = CableConnectionPool.current().connectUpdate(this.modelClassData().name, this.primaryKey(), callback)
    return cableSubscription
  }
  ...
  async create() {
    ...
    var response = await CommandsPool.addCommand({args: dataToUse, command: `${this.modelClassData().collectionKey}-create`, collectionKey: this.modelClassData().collectionKey, primaryKey: this.primaryKey(), type: "create"}, {})
  ...
  async createRaw(data) {
    ...
    var response = await CommandsPool.addCommand({args: formData, command: `${this.modelClassData().collectionKey}-create`, collectionKey: this.modelClassData().collectionKey, primaryKey: this.primaryKey(), type: "create"}, {})
  ...
  async destroy() {
    var response = await CommandsPool.addCommand({command: `${this.modelClassData().collectionKey}-destroy`, collectionKey: this.modelClassData().collectionKey, primaryKey: this.primaryKey(), type: "destroy"}, {})
  ...
  async update(newAttributes = null) {
    ...
    var response = await CommandsPool.addCommand({args: dataToUse, command: `${this.modelClassData().collectionKey}-update`, collectionKey: this.modelClassData().collectionKey, primaryKey: this.primaryKey(), type: "update"}, {})
  ...
  async updateRaw(data) {
    var formData = FormDataToObject.toObject(data)
    var response = await CommandsPool.addCommand({args: formData, command: `${this.modelClassData().collectionKey}-update`, collectionKey: this.modelClassData().collectionKey, primaryKey: this.primaryKey(), type: "update"}, {})
  ...
  async isValidOnServer() {
    ...
    var response = await CommandsPool.addCommand({args: dataToUse, command: `${this.modelClassData().collectionKey}-valid`, collectionKey: this.modelClassData().collectionKey, primaryKey: this.primaryKey(), type: "valid"}, {})
