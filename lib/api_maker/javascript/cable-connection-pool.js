...
export default class ApiMakerCableConnectionPool {
  ...
  connectModelClassEvent(modelName, eventName, callback) {
    ...
    if (!this.upcomingSubscriptionData[modelName]["model_class_events"])
    ...
    if (!this.upcomingSubscriptions[modelName]["model_class_events"])
      this.upcomingSubscriptions[modelName]["model_class_events"] = {}

    if (!this.upcomingSubscriptions[modelName]["model_class_events"])
      this.upcomingSubscriptions[modelName]["model_class_events"] = []
´
    if (!this.upcomingSubscriptions[modelName]["model_class_events"].includes(eventName))
      this.upcomingSubscriptions[modelName]["model_class_events"].push(eventName)
