...
var _class = function () {
  ...
  _createClass(_class, null, [{
    ...
    value: function get(path) {
      ...
      if (data) {
        var pathParamsString = qs__WEBPACK_IMPORTED_MODULE_0___default.a.stringify(data, { "arrayFormat": "brackets" });
    ...
    value: function post(path) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        xhr.open("POST", path);
        xhr.setRequestHeader("Content-Type", "application/json");
        xhr.setRequestHeader("X-CSRF-Token", _this2._token());
        xhr.onload = function () {
          var response = _this2._parseResponse(xhr);
...
/* harmony import */ var js_money__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! js-money */ "./node_modules/js-money/lib/index.js");
/* harmony import */ var js_money__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(js_money__WEBPACK_IMPORTED_MODULE_1__);
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
var _class = function () {
  ...
  _createClass(_class, [{
    ...
    value: function isValidOnServer() {
      ...
      return new Promise(function (resolve, reject) {
        var paramKey = _this6.constructor.modelClassData().paramKey;
        var urlToUse = _this6.constructor.modelClassData().path + "/validate";
        var modelData = _this6._saveData();
        var dataToUse = {};
        dataToUse[paramKey] = modelData;
        ...
        xhr.open("POST", urlToUse);
        xhr.setRequestHeader("Content-Type", "application/json");
        xhr.setRequestHeader("X-CSRF-Token", _this6.constructor._token());
        xhr.onload = function () {
          if (xhr.status == 200) {
            var response = JSON.parse(xhr.responseText);
            resolve({ "valid": response.valid, "errors": response.errors });
          } else {
            reject({ "model": _this6, "responseText": xhr.responseText });
          }
        };
        xhr.send(JSON.stringify(dataToUse));
      });
    ...
    value: function _getAttributeMoney(attributeName) {
      ...
      var money = js_money__WEBPACK_IMPORTED_MODULE_1___default.a.fromInteger(cents, currency);
      return money;
    }
  }, {
    ...
    value: function _loadBelongsToReflection(args) {
      ...
      return new Promise(function (resolve, reject) {
        if (args.reflectionName in _this7.relationshipsCache) {
          resolve(_this7.relationshipsCache[args.reflectionName]);
        } else {
          var collection = new _Collection__WEBPACK_IMPORTED_MODULE_0__["default"](args);
          collection.first().then(function (model) {
            _this7.relationshipsCache[args.reflectionName] = model;
            resolve(model);
          });
        }
      });
    ...
    value: function _readBelongsToReflection(args) {
      if (!(args.reflectionName in this.relationshipsCache)) throw args.reflectionName + " hasnt been loaded yet";
    ...
    value: function _loadHasOneReflection(args) {
      ...
      return new Promise(function (resolve, reject) {
        if (args.reflectionName in _this8.relationshipsCache) {
          resolve(_this8.relationshipsCache[args.reflectionName]);
        } else {
          var collection = new _Collection__WEBPACK_IMPORTED_MODULE_0__["default"](args);
          collection.first().then(function (model) {
            _this8.relationshipsCache[args.reflectionName] = model;
            resolve(model);
          });
        }
      });
...
var Project = function (_BaseModel) {
  ...
  _createClass(Project, [{
    ...
    value: function tasks() {
      var id = this.id();
      return new _Collection__WEBPACK_IMPORTED_MODULE_1__["default"]({ "reflectionName": "tasks", "modelName": "Task", "targetPathName": "/api_maker/tasks", "ransack": { "project_id_eq": id } });
    }
  }, {
    key: "loadTask",
...
/******/ });
//# sourceMappingURL=application-8946a4e9562cd98e15f6.js.map