...
/***/ "./app/javascript/ApiMaker/Api.js":
/*!****************************************!*\
  !*** ./app/javascript/ApiMaker/Api.js ***!
  \****************************************/
...
var _class = function () {
  ...
  _createClass(_class, null, [{
    ...
    value: function request(args) {
      ...
      if (args.pathParams) {
        var pathParamsString = qs__WEBPACK_IMPORTED_MODULE_0___default.a.stringify(args.pathParams, { "arrayFormat": "brackets" });
      ...
      return new Promise(function (resolve, reject) {
        ...
        xhr.onload = function () {
          var response = _this._parseResponse(xhr);
    ...
    key: "requestLocal",
    value: function requestLocal(args) {
      ...
      if (args.rawData) args["data"] = args.rawData;
    ...
    key: "_parseResponse",
    value: function _parseResponse(xhr) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Api__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Api */ "./app/javascript/ApiMaker/Api.js");
/* harmony import */ var _CableConnectionPool__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./CableConnectionPool */ "./app/javascript/ApiMaker/CableConnectionPool.js");
/* harmony import */ var _Collection__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Collection */ "./app/javascript/ApiMaker/Collection.js");
...
/* harmony import */ var _ModelName__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./ModelName */ "./app/javascript/ApiMaker/ModelName.js");
/* harmony import */ var js_money__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! js-money */ "./node_modules/js-money/lib/index.js");
...
!(function webpackMissingModule() { var e = new Error("Cannot find module 'object-to-formdata'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
var BaseModel = function () {
  _createClass(BaseModel, null, [{
    ...
    value: function find(id) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        _Api__WEBPACK_IMPORTED_MODULE_0__["default"].get(urlToUse).then(function (response) {
    ...
    value: function modelName() {
      return new _ModelName__WEBPACK_IMPORTED_MODULE_4__["default"]({ modelClassData: this.modelClassData() });
    }
  }, {
    key: "ransack",
    value: function ransack() {
      var query = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

      return new _Collection__WEBPACK_IMPORTED_MODULE_2__["default"]({ "ransack": query, "modelClass": this });
    }
  }]);
  ...
  _createClass(BaseModel, [{
    key: "connect",
    value: function connect(eventName, callback) {
      var cableSubscription = _CableConnectionPool__WEBPACK_IMPORTED_MODULE_1__["default"].current().connectEvent(this.modelClassData().name, this._primaryKey(), eventName, callback);
      return cableSubscription;
    }
  }, {
    key: "connectUpdated",
    value: function connectUpdated(callback) {
      var cableSubscription = _CableConnectionPool__WEBPACK_IMPORTED_MODULE_1__["default"].current().connectUpdate(this.modelClassData().name, this._primaryKey(), callback);
      return cableSubscription;
    }
  }, {
    ...
    value: function cacheKey() {
      if (this.isPersisted()) {
        var keyParts = [this.modelClassData().paramKey, this._primaryKey()];
    ...
    value: function create() {
      ...
      return new Promise(function (resolve, reject) {
        var paramKey = _this2.modelClassData().paramKey;
        var urlToUse = _this2.modelClassData().path;
        var modelData = _this2.getAttributes();
        var dataToUse = {};
        dataToUse[paramKey] = modelData;

        _Api__WEBPACK_IMPORTED_MODULE_0__["default"].post(urlToUse, dataToUse).then(function (response) {
          if (response.success) {
            if (response.model) {
              _this2.modelData = response.model.attributes;
              _this2.changes = {};
            }
    ...
    key: "createRaw",
    value: function createRaw(data) {
      var _this3 = this;

      return new Promise(function (resolve, reject) {
        var paramKey = _this3.modelClassData().paramKey;
        var urlToUse = _this3.modelClassData().path;

        _Api__WEBPACK_IMPORTED_MODULE_0__["default"].requestLocal({ path: urlToUse, method: "POST", rawData: data }).then(function (response) {
          if (response.success) {
            if (response.model) {
              _this3.modelData = response.model.attributes;
              _this3.changes = {};
            }
    ...
    value: function destroy() {
      ...
      return new Promise(function (resolve, reject) {
        var urlToUse = _this4.modelClassData().path + "/" + _this4._primaryKey();

        _Api__WEBPACK_IMPORTED_MODULE_0__["default"].delete(urlToUse).then(function (response) {
          if (response.success) {
            if (response.model) {
              _this4.modelData = response.model.attributes;
              _this4.changes = {};
            }
          ...
          reject({ "model": _this4, "response": response });
        });
      });
    }
  }, {
    ...
    value: function reload() {
      ...
      return new Promise(function (resolve, reject) {
        var urlToUse = _this5.modelClassData().path + "/" + _this5._primaryKey();

        _Api__WEBPACK_IMPORTED_MODULE_0__["default"].get(urlToUse).then(function (response) {
          if (response.model) {
            _this5.modelData = response.model.attributes;
            _this5.changes = {};
          }
    ...
    key: "saveRaw",
    value: function saveRaw(rawData) {
      if (this.isNewRecord()) {
    ...
    value: function update() {
      ...
      return new Promise(function (resolve, reject) {
        if (_this6.changes.length == 0) return resolve({ model: _this6 });

        var paramKey = _this6.modelClassData().paramKey;
        var urlToUse = _this6.modelClassData().path + "/" + _this6._primaryKey();
        var dataToUse = {};
        dataToUse[paramKey] = _this6.changes;

        if (Object.keys(dataToUse[paramKey]).length == 0) return resolve(resolve({ "model": _this6 }));

        _Api__WEBPACK_IMPORTED_MODULE_0__["default"].patch(urlToUse, dataToUse).then(function (response) {
          if (response.success) {
            if (response.model) {
              _this6.modelData = response.model.attributes;
              _this6.changes = {};
            }

            resolve({ "model": _this6, "response": response });
          } else {
            reject({ "model": _this6, "response": response });
          }
        }, function (response) {
          reject({ "model": _this6, "response": response });
        });
    ...
    key: "updateRaw",
    value: function updateRaw(data) {
      var _this7 = this;

      return new Promise(function (resolve, reject) {
        var paramKey = _this7.modelClassData().paramKey;
        var urlToUse = _this7.modelClassData().path + "/" + _this7._primaryKey();

        _Api__WEBPACK_IMPORTED_MODULE_0__["default"].requestLocal({ path: urlToUse, method: "PATCH", rawData: data }).then(function (response) {
          if (response.success) {
            if (response.model) {
              _this7.modelData = response.model.attributes;
              _this7.changes = {};
            }

            resolve({ "model": _this7, "response": response });
          } else {
            reject({ "model": _this7, "response": response });
          }
        }, function (response) {
          reject({ "model": _this7, "response": response });
        });
    ...
    key: "isValidOnServer",
    value: function isValidOnServer() {
      var _this8 = this;

      return new Promise(function (resolve, reject) {
        var paramKey = _this8.modelClassData().paramKey;
        var urlToUse = _this8.modelClassData().path + "/validate";
        var modelData = _this8.getAttributes();
        var dataToUse = {};
        dataToUse[paramKey] = modelData;
        ...
        _Api__WEBPACK_IMPORTED_MODULE_0__["default"].post(urlToUse, dataToUse).then(function (response) {
          ...
          reject({ "model": _this8, "response": response });
        });
      });
    }
  }, {
    ...
    key: "preloadRelationship",
    value: function preloadRelationship(relationshipName, model) {
    ...
    key: "_callmemberCommand",
    value: function _callmemberCommand(args) {
      var _this9 = this;

      return new Promise(function (resolve, reject) {
        var url = "/api_maker/" + args.model.modelClassData().pluralName + "/" + args.model._primaryKey() + "/" + args.memberCommand;
        var postData = BaseModel._postDataFromArgs(args.args);

        postData.append("plural_name", _this9.modelClassData().pluralName);
        postData.append("member_command", args.memberCommand);

        _Api__WEBPACK_IMPORTED_MODULE_0__["default"].requestLocal({ path: url, method: "POST", rawData: postData }).then(function (response) {
          resolve(response);
        }, function (response) {
          reject(response);
        });
    ...
    key: "_getAttribute",
    value: function _getAttribute(attributeName) {
      if (attributeName in this.changes) {
        ...
        for (var key in attributes) {
          ...
          if (attribute.name == attributeName) return null;
        }
      }
    ...
    key: "_getAttributeDateTime",
    value: function _getAttributeDateTime(attributeName) {
    ...
    key: "_getAttributeMoney",
    value: function _getAttributeMoney(attributeName) {
      var value = this._getAttribute(attributeName);
      ...
      return js_money__WEBPACK_IMPORTED_MODULE_5___default.a.fromInteger(cents, currency);
    }
  }, {
    key: "_loadBelongsToReflection",
    value: function _loadBelongsToReflection(args) {
      var _this10 = this;

      return new Promise(function (resolve, reject) {
        if (args.reflectionName in _this10.relationshipsCache) {
          resolve(_this10.relationshipsCache[args.reflectionName]);
        } else {
          var collection = new _Collection__WEBPACK_IMPORTED_MODULE_2__["default"](args);
          collection.first().then(function (model) {
            _this10.relationshipsCache[args.reflectionName] = model;
            resolve(model);
          });
        }
      });
    ...
    key: "_loadHasOneReflection",
    value: function _loadHasOneReflection(args) {
      var _this11 = this;

      return new Promise(function (resolve, reject) {
        if (args.reflectionName in _this11.relationshipsCache) {
          resolve(_this11.relationshipsCache[args.reflectionName]);
        } else {
          var collection = new _Collection__WEBPACK_IMPORTED_MODULE_2__["default"](args);
          collection.first().then(function (model) {
            _this11.relationshipsCache[args.reflectionName] = model;
            resolve(model);
          });
        }
      });
    ...
    key: "_readModelDataFromArgs",
    value: function _readModelDataFromArgs(args) {
      var _this12 = this;

      this.modelData = args.data.attributes;

      if (!args.data.relationships) return;

      var _loop = function _loop(relationshipName) {
        var relationshipData = args.data.relationships[relationshipName];

        if (!relationshipData) {
          _this12.relationshipsCache[relationshipName] = null;
        } else if (Array.isArray(relationshipData.data)) {
          var result = [];

          var _loop2 = function _loop2(relationshipDataIKey) {
            var relationshipDataI = relationshipData.data[relationshipDataIKey];

            var includedData = args.response.included.find(function (included) {
              return included.type == relationshipDataI.type && included.id == relationshipDataI.id;
            });

            if (!includedData) throw new Error("Couldn't find included data for " + relationshipName);

            var modelClassName = inflection__WEBPACK_IMPORTED_MODULE_3___default.a.classify(inflection__WEBPACK_IMPORTED_MODULE_3___default.a.singularize(includedData.type));
            var modelClass = __webpack_require__("./app/javascript/ApiMaker/Models sync recursive ^\\.\\/.*$")("./" + modelClassName).default;
          ...
          for (var relationshipDataIKey in relationshipData.data) {
            _loop2(relationshipDataIKey);
          }

          _this12.relationshipsCache[relationshipName] = result;
        } else {
          var includedData = args.response.included.find(function (included) {
          ...
          _this12.relationshipsCache[relationshipName] = model;
        }
      };

      for (var relationshipName in args.data.relationships) {
        _loop(relationshipName);
      }
    }
  }, {
    key: "_primaryKey",
    ...
    key: "humanAttributeName",
    value: function humanAttributeName(attributeName) {
    ...
    value: function snakeCase(string) {
      var changeCase = __webpack_require__(/*! change-case */ "./node_modules/change-case/change-case.js");
      return changeCase.snakeCase(string).replace(/\d+/, "_$&");
    }
  }, {
    key: "_callcollectionCommand",
    value: function _callcollectionCommand(args) {
      return new Promise(function (resolve, reject) {
    ...
    key: "_postDataFromArgs",
    value: function _postDataFromArgs(args) {
      var postData = void 0;
      ...
      if (args) {
        if (args instanceof FormData) {
          ...
          postData = !(function webpackMissingModule() { var e = new Error("Cannot find module 'object-to-formdata'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(args, {}, null, "args");
        }
      } else {
...
/***/ "./app/javascript/ApiMaker/CableConnectionPool.js":
/*!********************************************************!*\
  !*** ./app/javascript/ApiMaker/CableConnectionPool.js ***!
  \********************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _CableSubscriptionPool__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./CableSubscriptionPool */ "./app/javascript/ApiMaker/CableSubscriptionPool.js");
/* harmony import */ var _CableSubscription__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./CableSubscription */ "./app/javascript/ApiMaker/CableSubscription.js");
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
var ApiMakerCableConnectionPool = function () {
  _createClass(ApiMakerCableConnectionPool, null, [{
    key: "current",
    value: function current() {
      if (!window.apiMakerCableConnectionPool) window.apiMakerCableConnectionPool = new ApiMakerCableConnectionPool();

      return window.apiMakerCableConnectionPool;
    }
  }]);

  function ApiMakerCableConnectionPool() {
    _classCallCheck(this, ApiMakerCableConnectionPool);
  ...
  _createClass(ApiMakerCableConnectionPool, [{
    key: "connectEvent",
    value: function connectEvent(modelName, modelId, eventName, callback) {
      if (!this.upcomingSubscriptionData[modelName]) this.upcomingSubscriptionData[modelName] = {};

      if (!this.upcomingSubscriptionData[modelName]["events"]) this.upcomingSubscriptionData[modelName]["events"] = {};

      if (!this.upcomingSubscriptionData[modelName]["events"][eventName]) this.upcomingSubscriptionData[modelName]["events"][eventName] = [];

      if (!this.upcomingSubscriptionData[modelName]["events"][eventName].includes(modelId)) this.upcomingSubscriptionData[modelName]["events"][eventName].push(modelId);

      if (!this.upcomingSubscriptions[modelName]) this.upcomingSubscriptions[modelName] = {};

      if (!this.upcomingSubscriptions[modelName]["events"]) this.upcomingSubscriptions[modelName]["events"] = {};

      if (!this.upcomingSubscriptions[modelName]["events"]) this.upcomingSubscriptions[modelName]["events"] = {};

      if (!this.upcomingSubscriptions[modelName]["events"][modelId]) this.upcomingSubscriptions[modelName]["events"][modelId] = {};

      if (!this.upcomingSubscriptions[modelName]["events"][modelId][eventName]) this.upcomingSubscriptions[modelName]["events"][modelId][eventName] = [];

      var subscription = new _CableSubscription__WEBPACK_IMPORTED_MODULE_1__["default"]({
        callback: callback,
        modelName: modelName,
        modelId: modelId
      });
    ...
    key: "connectUpdate",
    value: function connectUpdate(modelName, modelId, callback) {
      if (!this.upcomingSubscriptionData[modelName]) this.upcomingSubscriptionData[modelName] = {};

      if (!this.upcomingSubscriptionData[modelName]["updates"]) this.upcomingSubscriptionData[modelName]["updates"] = [];

      if (!this.upcomingSubscriptionData[modelName]["updates"].includes(modelId)) this.upcomingSubscriptionData[modelName]["updates"].push(modelId);

      if (!this.upcomingSubscriptions[modelName]) this.upcomingSubscriptions[modelName] = {};

      if (!this.upcomingSubscriptions[modelName]["updates"]) this.upcomingSubscriptions[modelName]["updates"] = {};

      if (!this.upcomingSubscriptions[modelName]["updates"][modelId]) this.upcomingSubscriptions[modelName]["updates"][modelId] = [];
    ...
    key: "connectUpcoming",
    value: function connectUpcoming() {
      ...
      var cableSubscriptionPool = new _CableSubscriptionPool__WEBPACK_IMPORTED_MODULE_0__["default"]({
    ...
    key: "scheduleConnectUpcoming",
    value: function scheduleConnectUpcoming() {
      var _this = this;

      if (this.scheduleConnectUpcomingTimeout) clearTimeout(this.scheduleConnectUpcomingTimeout);

      this.scheduleConnectUpcomingTimeout = setTimeout(function () {
        _this.connectUpcoming();
      }, 50);
    }
  }]);

  return ApiMakerCableConnectionPool;
}();

/* harmony default export */ __webpack_exports__["default"] = (ApiMakerCableConnectionPool);

/***/ }),

/***/ "./app/javascript/ApiMaker/CableSubscription.js":
/*!******************************************************!*\
  !*** ./app/javascript/ApiMaker/CableSubscription.js ***!
  \******************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Logger__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Logger */ "./app/javascript/ApiMaker/Logger.js");
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
var ApiMakerCableSubscription = function () {
  function ApiMakerCableSubscription(props) {
    _classCallCheck(this, ApiMakerCableSubscription);
  ...
  _createClass(ApiMakerCableSubscription, [{
    key: "onReceived",
    value: function onReceived(data) {
      this.props.callback.apply(null, [data]);
    }
  }, {
    key: "onUnsubscribe",
    value: function onUnsubscribe(callback) {
    ...
    value: function unsubscribe() {
      if (!this.subscribed) {
        _Logger__WEBPACK_IMPORTED_MODULE_0__["default"].log("Unsubscribed already called");
        return;
      }

      _Logger__WEBPACK_IMPORTED_MODULE_0__["default"].log("Unsubscribe called: " + this.onUnsubscribeCallbacks.length);
      ...
      try {
        for (var _iterator = this.onUnsubscribeCallbacks[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          var onUnsubscribeCallback = _step.value;

          _Logger__WEBPACK_IMPORTED_MODULE_0__["default"].log("onUnsubscribe called for a callback");
  ...
  return ApiMakerCableSubscription;
}();

/* harmony default export */ __webpack_exports__["default"] = (ApiMakerCableSubscription);

/***/ }),

/***/ "./app/javascript/ApiMaker/CableSubscriptionPool.js":
/*!**********************************************************!*\
  !*** ./app/javascript/ApiMaker/CableSubscriptionPool.js ***!
  \**********************************************************/
/*! exports provided: default */
...
/* harmony import */ var _Logger__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Logger */ "./app/javascript/ApiMaker/Logger.js");
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
var ApiMakerCableSubscriptionPool = function () {
  function ApiMakerCableSubscriptionPool(props) {
    _classCallCheck(this, ApiMakerCableSubscriptionPool);
  ...
  _createClass(ApiMakerCableSubscriptionPool, [{
    key: "connect",
    ...
    key: "onReceived",
    value: function onReceived(data) {
      var modelName = inflection__WEBPACK_IMPORTED_MODULE_0___default.a.camelize(inflection__WEBPACK_IMPORTED_MODULE_0___default.a.singularize(data.model.type));
      var modelId = data.model.id;
      var modelClass = __webpack_require__("./app/javascript/ApiMaker/Models sync recursive ^\\.\\/.*$")("./" + modelName).default;
      ...
      if (data.type == "update") {
        ...
        try {
          for (var _iterator = this.props.subscriptions[modelName]["updates"][modelId][Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        ...
        try {
          for (var _iterator2 = this.props.subscriptions[modelName]["events"][modelId][data.event_name][Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
            var _subscription = _step2.value;

            _subscription.onReceived({
              args: data.args,
    ...
    value: function onUnsubscribe() {
      _Logger__WEBPACK_IMPORTED_MODULE_1__["default"].log("activeSubscriptions before unsub: " + this.activeSubscriptions);
      this.activeSubscriptions -= 1;
      _Logger__WEBPACK_IMPORTED_MODULE_1__["default"].log("activeSubscriptions after unsub: " + this.activeSubscriptions);

      if (this.activeSubscriptions <= 0) {
        _Logger__WEBPACK_IMPORTED_MODULE_1__["default"].log("Unsubscribe from ActionCable subscription");
    ...
    value: function registerSubscriptions() {
      _Logger__WEBPACK_IMPORTED_MODULE_1__["default"].log("registerSubscriptions: " + this.props.subscriptions.length);
      _Logger__WEBPACK_IMPORTED_MODULE_1__["default"].log(this.props.subscriptions);

      for (var modelName in this.props.subscriptions) {
        _Logger__WEBPACK_IMPORTED_MODULE_1__["default"].log({ modelName: modelName });
        ...
        if (this.props.subscriptions[modelName]["events"]) {
          for (var eventName in this.props.subscriptions[modelName]["events"]) {
            for (var modelId in this.props.subscriptions[modelName]["events"][eventName]) {
              ...
              try {
                for (var _iterator3 = this.props.subscriptions[modelName]["events"][eventName][modelId][Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
        ...
        if (this.props.subscriptions[modelName]["updates"]) {
          for (var _modelId in this.props.subscriptions[modelName]["updates"]) {
            var _iteratorNormalCompletion4 = true;
            var _didIteratorError4 = false;
            var _iteratorError4 = undefined;

            try {
              for (var _iterator4 = this.props.subscriptions[modelName]["updates"][_modelId][Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
                var _subscription2 = _step4.value;

                this.connectUnsubscriptionForSubscription(_subscription2);
              }
            } catch (err) {
    ...
    key: "connectUnsubscriptionForSubscription",
    value: function connectUnsubscriptionForSubscription(subscription) {
      var _this2 = this;

      _Logger__WEBPACK_IMPORTED_MODULE_1__["default"].log("Connecting to unsubscribe on subscription");
      _Logger__WEBPACK_IMPORTED_MODULE_1__["default"].log({ subscription: subscription });

      this.activeSubscriptions += 1;

      subscription.onUnsubscribe(function () {
        _Logger__WEBPACK_IMPORTED_MODULE_1__["default"].log("Call onUnsubscribe on self");

        _this2.onUnsubscribe(subscription);
      });
    }
  }]);

  return ApiMakerCableSubscriptionPool;
}();

/* harmony default export */ __webpack_exports__["default"] = (ApiMakerCableSubscriptionPool);
...
/* harmony import */ var _ModelsResponseReader__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./ModelsResponseReader */ "./app/javascript/ApiMaker/ModelsResponseReader.js");
...
/* harmony import */ var _Result__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./Result */ "./app/javascript/ApiMaker/Result.js");
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
var Collection = function () {
  ...
  _createClass(Collection, [{
    key: "accessibleBy",
    value: function accessibleBy(abilityName) {
    ...
    key: "preload",
    value: function preload(preloadValue) {
    ...
    value: function page(pageNumber) {
      ...
      if (!this.args.ransack || !this.args.ransack.s) changes.ransack = { s: this.args.modelClass.modelClassData().primaryKey + " asc" };

      return this._clone(changes);
    }
  }, {
    key: "pageKey",
    value: function pageKey(pageKeyValue) {
    ...
    value: function result() {
      ...
      return new Promise(function (resolve, reject) {
        _this2._response().then(function (response) {
          var models = _this2._responseToModels(response);
          var result = new _Result__WEBPACK_IMPORTED_MODULE_5__["default"]({
            "collection": _this2,
            "models": models,
            "response": response
          });
    ...
    key: "searchKey",
    value: function searchKey(_searchKey) {
      return this._clone({ searchKey: _searchKey });
    }
  }, {
    key: "sort",
    ...
    value: function toArray() {
      ...
      return new Promise(function (resolve, reject) {
        _this3._response().then(function (response) {
          var models = _this3._responseToModels(response);
          resolve(models);
        });
      });
    }
    ...
    key: "modelClass",
    value: function modelClass() {
      return __webpack_require__("./app/javascript/ApiMaker/Models sync recursive ^\\.\\/.*$")("./" + this.args.modelClass.modelClassData().name).default;
    }
  }, {
    key: "_clone",
    value: function _clone(args) {
      return new Collection(this._merge(this.args, args));
    }
  }, {
    key: "_merge",
    value: function _merge(object1, object2) {
      return merge__WEBPACK_IMPORTED_MODULE_2___default.a.recursive(true, object1, object2);
    }
  }, {
    key: "_response",
    value: function _response() {
      ...
      return new Promise(function (resolve, reject) {
        var dataToUse = qs__WEBPACK_IMPORTED_MODULE_4___default.a.stringify(_this4._params(), { arrayFormat: "brackets" });
        var urlToUse = _this4.args.modelClass.modelClassData().path + "?" + dataToUse;
    ...
    key: "_responseToModels",
    value: function _responseToModels(response) {
      var modelsResponseReader = new _ModelsResponseReader__WEBPACK_IMPORTED_MODULE_3__["default"]({ response: response });
    ...
    value: function _params() {
      ...
      if (this.args.params) params = this._merge(params, this.args.params);

      if (this.args.accessibleBy) {
        params.accessible_by = inflection__WEBPACK_IMPORTED_MODULE_1___default.a.underscore(this.args.accessibleBy);
      }

      if (this.args.ransack) params.q = this.args.ransack;

      if (this.args.limit) params.limit = this.args.limit;

      if (this.args.preload) params.include = this.args.preload;

      if (this.args.page) params.page = this.args.page;
...
var Devise = function () {
  function Devise() {
    _classCallCheck(this, Devise);
  }

  _createClass(Devise, null, [{
    key: "isUserSignedIn",
    ...
    value: function signIn(username, password) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        _Api__WEBPACK_IMPORTED_MODULE_0__["default"].post("/api_maker/devise/do_sign_in", postData).then(function (response) {
          var modelClass = __webpack_require__("./app/javascript/ApiMaker/Models sync recursive ^\\.\\/.*$")("./" + changeCase.pascalCase(args.scope)).default;
    ...
    key: "updateSession",
    value: function updateSession(model) {
      var apiMakerDataElement = document.querySelector(".api-maker-data");
    ...
    value: function signOut() {
      ...
      return new Promise(function (resolve, reject) {
        ...
        _Api__WEBPACK_IMPORTED_MODULE_0__["default"].post("/api_maker/devise/do_sign_out", postData).then(function (response) {
          var apiMakerDataElement = document.querySelector(".api-maker-data");
...
/* harmony default export */ __webpack_exports__["default"] = (Devise);

/***/ }),

/***/ "./app/javascript/ApiMaker/Logger.js":
/*!*******************************************!*\
  !*** ./app/javascript/ApiMaker/Logger.js ***!
  \*******************************************/
/*! exports provided: default */
...
var ApiMakerLogger = function () {
  function ApiMakerLogger() {
    _classCallCheck(this, ApiMakerLogger);
  }

  _createClass(ApiMakerLogger, [{
    key: "log",
    value: function log(message) {
      if (this.debug) console.log("ApiMaker: " + message);
    }
  }, {
    key: "setDebug",
    ...
    key: "current",
    value: function current() {
      if (!window.apiMakerLogger) window.apiMakerLogger = new ApiMakerLogger();
  ...
  return ApiMakerLogger;
}();

/* harmony default export */ __webpack_exports__["default"] = (ApiMakerLogger);

/***/ }),

/***/ "./app/javascript/ApiMaker/ModelName.js":
/*!**********************************************!*\
  !*** ./app/javascript/ApiMaker/ModelName.js ***!
  \**********************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (ModelName);
...
var map = {
	"./Account": "./app/javascript/ApiMaker/Models/Account.js",
	"./Account.js": "./app/javascript/ApiMaker/Models/Account.js",
	"./Customer": "./app/javascript/ApiMaker/Models/Customer.js",
	"./Customer.js": "./app/javascript/ApiMaker/Models/Customer.js",
	"./Project": "./app/javascript/ApiMaker/Models/Project.js",
	"./Project.js": "./app/javascript/ApiMaker/Models/Project.js",
	"./ProjectDetail": "./app/javascript/ApiMaker/Models/ProjectDetail.js",
	"./ProjectDetail.js": "./app/javascript/ApiMaker/Models/ProjectDetail.js",
...
/***/ "./app/javascript/ApiMaker/Models/Account.js":
/*!***************************************************!*\
  !*** ./app/javascript/ApiMaker/Models/Account.js ***!
  \***************************************************/
/*! exports provided: default */
...
var Account = function (_BaseModel) {
  ...
  _createClass(Account, [{
    ...
    value: function projects() {
      var id = this.id();
      var modelClass = __webpack_require__(/*! ApiMaker/Models/Project */ "./app/javascript/ApiMaker/Models/Project.js").default;
      return new _Collection__WEBPACK_IMPORTED_MODULE_1__["default"]({ "reflectionName": "projects", "model": this, "modelName": "Project", "modelClass": modelClass, "targetPathName": "/api_maker/projects", "ransack": { "account_id_eq": id } });
    }
  }, {
    key: "id",
    value: function id() {
...
/***/ "./app/javascript/ApiMaker/Models/Customer.js":
/*!****************************************************!*\
  !*** ./app/javascript/ApiMaker/Models/Customer.js ***!
  \****************************************************/
/*! exports provided: default */
...
var Customer = function (_BaseModel) {
  _inherits(Customer, _BaseModel);
...
var Project = function (_BaseModel) {
  ...
  _createClass(Project, [{
    key: "loadProjectDetail",
    value: function loadProjectDetail() {
      var id = this.id();
      var modelClass = __webpack_require__(/*! ApiMaker/Models/ProjectDetail */ "./app/javascript/ApiMaker/Models/ProjectDetail.js").default;
    ...
    value: function tasks() {
      var id = this.id();
      var modelClass = __webpack_require__(/*! ApiMaker/Models/Task */ "./app/javascript/ApiMaker/Models/Task.js").default;
      return new _Collection__WEBPACK_IMPORTED_MODULE_1__["default"]({ "reflectionName": "tasks", "model": this, "modelName": "Task", "modelClass": modelClass, "targetPathName": "/api_maker/tasks", "ransack": { "project_id_eq": id } });
    }
  }, {
    key: "id",
    value: function id() {
...
/***/ "./app/javascript/ApiMaker/Models/ProjectDetail.js":
/*!*********************************************************!*\
  !*** ./app/javascript/ApiMaker/Models/ProjectDetail.js ***!
  \*********************************************************/
/*! exports provided: default */
...
var ProjectDetail = function (_BaseModel) {
  _inherits(ProjectDetail, _BaseModel);
...
var Task = function (_BaseModel) {
  ...
  _createClass(Task, [{
    ...
    key: "hasCustomId",
    value: function hasCustomId() {
      var value = this.customId();
      return this._isPresent(value);
    }
  }, {
    key: "testMember",
    value: function testMember(args) {
    ...
    key: "testCollection",
    value: function testCollection(args) {
...
var User = function (_BaseModel) {
  ...
  _createClass(User, [{
    ...
    key: "customAttribute",
    value: function customAttribute() {
      // unknown

      return this._getAttribute("custom_attribute");
    }
  }, {
    key: "hasCustomAttribute",
    value: function hasCustomAttribute() {
...
/***/ "./app/javascript/ApiMaker/ModelsResponseReader.js":
/*!*********************************************************!*\
  !*** ./app/javascript/ApiMaker/ModelsResponseReader.js ***!
  \*********************************************************/
/*! exports provided: default */
...
var ModelsResponseReader = function () {
  _createClass(ModelsResponseReader, null, [{
    key: "first",
  ...
  function ModelsResponseReader(args) {
    _classCallCheck(this, ModelsResponseReader);

    this.response = args.response;
  }

  _createClass(ModelsResponseReader, [{
    key: "models",
    value: function models() {
      ...
      try {
        for (var _iterator = this.response.data[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          var modelData = _step.value;

          var modelClassName = inflection__WEBPACK_IMPORTED_MODULE_0___default.a.classify(inflection__WEBPACK_IMPORTED_MODULE_0___default.a.singularize(modelData.type));
          var modelClass = __webpack_require__("./app/javascript/ApiMaker/Models sync recursive ^\\.\\/.*$")("./" + modelClassName).default;
  ...
  return ModelsResponseReader;
}();

/* harmony default export */ __webpack_exports__["default"] = (ModelsResponseReader);

/***/ }),

/***/ "./app/javascript/ApiMaker/Result.js":
/*!*******************************************!*\
  !*** ./app/javascript/ApiMaker/Result.js ***!
  \*******************************************/
/*! exports provided: default */
...
var map = {
	"./commands/collection_controller.js": "./app/javascript/controllers/commands/collection_controller.js",
	"./commands/member_controller.js": "./app/javascript/controllers/commands/member_controller.js",
	"./devise/current_user_controller.js": "./app/javascript/controllers/devise/current_user_controller.js",
	"./devise/sign_in_controller.js": "./app/javascript/controllers/devise/sign_in_controller.js",
	"./devise/sign_out_controller.js": "./app/javascript/controllers/devise/sign_out_controller.js",
	"./models/accessible_by_controller.js": "./app/javascript/controllers/models/accessible_by_controller.js",
	...
	"./models/validate_controller.js": "./app/javascript/controllers/models/validate_controller.js"
};
...
/***/ "./app/javascript/controllers/commands/collection_controller.js":
/*!**********************************************************************!*\
  !*** ./app/javascript/controllers/commands/collection_controller.js ***!
  \**********************************************************************/
/*! exports provided: default */
...
var _class = function (_Controller) {
  ...
  _createClass(_class, [{
    ...
    value: function connect() {
      ...
      ApiMaker_Models_Task__WEBPACK_IMPORTED_MODULE_1__["default"].testCollection().then(function (response) {
        _this2.element.dataset.testCollectionResponse = JSON.stringify(response);
      });
    }
  }]);
...
/***/ "./app/javascript/controllers/commands/member_controller.js":
/*!******************************************************************!*\
  !*** ./app/javascript/controllers/commands/member_controller.js ***!
  \******************************************************************/
/*! exports provided: default */
  ...
  _createClass(_class, [{
    ...
    value: function connect() {
      ...
      ApiMaker_Models_Task__WEBPACK_IMPORTED_MODULE_1__["default"].find(this.element.dataset.taskId).then(function (task) {
        task.testMember().then(function (response) {
          _this2.element.dataset.testMemberResponse = JSON.stringify(response);
        });
      });
    }
  }]);
...
var _class = function (_Controller) {
  ...
  _createClass(_class, [{
    key: "connect",
    value: function connect() {
      var user = ApiMaker_Devise__WEBPACK_IMPORTED_MODULE_1__["default"].currentUser();
...
/***/ "./app/javascript/controllers/devise/sign_in_controller.js":
/*!*****************************************************************!*\
  !*** ./app/javascript/controllers/devise/sign_in_controller.js ***!
  \*****************************************************************/
/*! exports provided: default */
...
var _class = function (_Controller) {
  ...
  _createClass(_class, [{
    ...
    value: function onSubmit(e) {
      ...
      ApiMaker_Devise__WEBPACK_IMPORTED_MODULE_1__["default"].signIn(this.emailTarget.value, this.passwordTarget.value, { rememberMe: this.rememberTarget.checked }).then(function (response) {
        _this2.element.dataset["successResponse"] = JSON.stringify(response);
      }, function (response) {
        _this2.element.dataset["failResponse"] = JSON.stringify(response);
      });
    }
  }]);
...
Object.defineProperty(_class, "targets", {
  enumerable: true,
  writable: true,
  value: ["email", "password", "remember"]
});
/* harmony default export */ __webpack_exports__["default"] = (_class);

/***/ }),

/***/ "./app/javascript/controllers/devise/sign_out_controller.js":
/*!******************************************************************!*\
  !*** ./app/javascript/controllers/devise/sign_out_controller.js ***!
  \******************************************************************/
/*! exports provided: default */
...
var _class = function (_Controller) {
  ...
  _createClass(_class, [{
    ...
    value: function onSignOutClicked(e) {
      var _this2 = this;

      e.preventDefault();

      ApiMaker_Devise__WEBPACK_IMPORTED_MODULE_1__["default"].signOut().then(function (response) {
        _this2.element.dataset["successResponse"] = JSON.stringify(response);
      }, function (response) {
        _this2.element.dataset["failResponse"] = JSON.stringify(response);
      });
...
/***/ "./app/javascript/controllers/models/accessible_by_controller.js":
/*!***********************************************************************!*\
  !*** ./app/javascript/controllers/models/accessible_by_controller.js ***!
  \***********************************************************************/
/*! exports provided: default */
...
var _class = function (_Controller) {
  ...
  _createClass(_class, [{
    ...
    value: function connect() {
      ...
      ApiMaker_Models_Task__WEBPACK_IMPORTED_MODULE_1__["default"].ransack().accessibleBy("testAccessibleBy").toArray().then(function (tasks) {
        var result = [];
        var _iteratorNormalCompletion = true;
        var _didIteratorError = false;
        var _iteratorError = undefined;
        ...
        _this2.element.dataset.result = JSON.stringify(result);
        _this2.element.dataset.accessibleByCompleted = true;
      });
    }
  }]);
...
var _class = function (_Controller) {
  ...
  _createClass(_class, [{
    ...
    value: function connect() {
      ...
      ApiMaker_Models_Task__WEBPACK_IMPORTED_MODULE_1__["default"].find(this.element.dataset.taskId).then(function (task) {
        task.loadProject().then(function () {
...
var _class = function (_Controller) {
  ...
  _createClass(_class, [{
    ...
    value: function connect() {
      ...
      ApiMaker_Models_Project__WEBPACK_IMPORTED_MODULE_1__["default"].find(this.element.dataset.projectId).then(function (project) {
        _this2.element.dataset.projectData = JSON.stringify(project);
        _this2.element.dataset.findCompleted = true;
      });
    }
  }]);
...
var _class = function (_Controller) {
  ...
  _createClass(_class, [{
    ...
    value: function connect() {
      ...
      ApiMaker_Models_Project__WEBPACK_IMPORTED_MODULE_1__["default"].find(this.element.dataset.projectId).then(function (project) {
        project.loadProjectDetail().then(function () {
          var result = { "id": project.projectDetail().id(), "details": project.projectDetail().details() };

          _this2.element.dataset.projectDetail = JSON.stringify(result);
...
var _class = function (_Controller) {
  ...
  _createClass(_class, [{
    ...
    value: function connect() {
      ...
      ApiMaker_Models_Task__WEBPACK_IMPORTED_MODULE_1__["default"].ransack({ "id_eq": this.element.taskId }).preload("project").first().then(function (taskWithPreload) {
        _this2.element.dataset.taskWithPreload = JSON.stringify(taskWithPreload);

        ApiMaker_Models_Task__WEBPACK_IMPORTED_MODULE_1__["default"].ransack({ "id_eq": _this2.element.taskId }).first().then(function (taskWithoutPreload) {
          _this2.element.dataset.taskWithoutPreload = JSON.stringify(taskWithoutPreload);
...
var _class = function (_Controller) {
  ...
  _createClass(_class, [{
    ...
    value: function connect() {
      ...
      var promiseWithoutPreload = ApiMaker_Models_Project__WEBPACK_IMPORTED_MODULE_1__["default"].ransack({ name_cont: "test-ransack" }).toArray().then(function (projects) {
        _this2.element.dataset.projectsWithoutPreload = JSON.stringify(projects);
      });
      var promiseWithPreload = ApiMaker_Models_Project__WEBPACK_IMPORTED_MODULE_1__["default"].ransack({ name_cont: "test-ransack" }).preload("tasks").toArray().then(function (projects) {
        _this2.element.dataset.projectsWithPreload = JSON.stringify(projects);
      });
      Promise.all([promiseWithoutPreload, promiseWithPreload]).then(function () {
...
var _class = function (_Controller) {
  ...
  _createClass(_class, [{
    ...
    value: function connect() {
      ...
      var result = {};
      var project = new ApiMaker_Models_Project__WEBPACK_IMPORTED_MODULE_1__["default"]({ name: "not-renamed" });
...
/***/ "./app/javascript/controllers/models/validate_controller.js":
/*!******************************************************************!*\
  !*** ./app/javascript/controllers/models/validate_controller.js ***!
  \******************************************************************/
/*! exports provided: default */
...
var _class = function (_Controller) {
  ...
  _createClass(_class, [{
    ...
    value: function connect() {
      ...
      var task = new ApiMaker_Models_Task__WEBPACK_IMPORTED_MODULE_1__["default"]({ name: " " });
      task.isValidOnServer().then(function (response) {
        _this2.element.dataset.validateResponse = JSON.stringify(response);
      });
    }
  }]);
...
/***/ "./node_modules/js-money/lib/currency.js":
/*!***********************************************!*\
  !*** ./node_modules/js-money/lib/currency.js ***!
  \***********************************************/
/*! no static exports found */
...
/***/ "./node_modules/js-money/lib/index.js":
/*!********************************************!*\
  !*** ./node_modules/js-money/lib/index.js ***!
  \********************************************/
/*! no static exports found */
...
module.exports = __webpack_require__(/*! ./money */ "./node_modules/js-money/lib/money.js");


/***/ }),

/***/ "./node_modules/js-money/lib/money.js":
/*!********************************************!*\
  !*** ./node_modules/js-money/lib/money.js ***!
  \********************************************/
/*! no static exports found */
...
var currencies = __webpack_require__(/*! ./currency */ "./node_modules/js-money/lib/currency.js");
...
/******/ });
//# sourceMappingURL=application-9fbb211e8925f3c9899c.js.map