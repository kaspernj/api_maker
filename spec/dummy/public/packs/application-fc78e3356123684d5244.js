...
/* harmony import */ var _ModelName__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./ModelName */ "./app/javascript/ApiMaker/ModelName.js");
/* harmony import */ var js_money__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! js-money */ "./node_modules/js-money/lib/index.js");
/* harmony import */ var js_money__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(js_money__WEBPACK_IMPORTED_MODULE_3__);
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
var BaseModel = function () {
  _createClass(BaseModel, null, [{
    ...
    value: function modelName() {
      return new _ModelName__WEBPACK_IMPORTED_MODULE_2__["default"]({ modelClassData: this.modelClassData() });
    }
  }, {
    key: "ransack",
  ...
  _createClass(BaseModel, [{
    ...
    value: function connect(eventName, callback) {
      ...
      return App.cable.subscriptions.create({ channel: "ModelUpdates::EventsChannel", callback_data: callbackData }, { received: callback });
    }
  }, {
    ...
    key: "_callMemberMethod",
    value: function _callMemberMethod(args) {
      return new Promise(function (resolve, reject) {
    ...
    value: function _getAttributeMoney(attributeName) {
      ...
      return js_money__WEBPACK_IMPORTED_MODULE_3___default.a.fromInteger(cents, currency);
    }
  }, {
    key: "_preloadRelationships",
    value: function _preloadRelationships() {
      var modelClassData = this.modelClassData();
      ...
      for (var key in modelClassData.relationships) {
        ...
        if (!(relationship.name in this.modelData)) continue;
        ...
        var modelClass = __webpack_require__("./app/javascript/ApiMaker/Models sync recursive ^\\.\\/.*$")("./" + relationship.className).default;
    ...
    key: "_callCollectionMethod",
    value: function _callCollectionMethod(args) {
      return new Promise(function (resolve, reject) {
...
/* harmony import */ var _Result__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Result */ "./app/javascript/ApiMaker/Result.js");
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
var Collection = function () {
  ...
  _createClass(Collection, [{
    ...
    value: function loaded() {
      if (!(this.args.reflectionName in this.args.model.relationshipsCache)) throw this.args.reflectionName + " hasnt been loaded yet";
    ...
    value: function result() {
      ...
      return new Promise(function (resolve, reject) {
        _this2._response().then(function (response) {
          ...
          var result = new _Result__WEBPACK_IMPORTED_MODULE_2__["default"]({
            "models": models,
            "response": response
          });
          resolve(result);
    ...
    value: function _response() {
      ...
      return new Promise(function (resolve, reject) {
        var dataToUse = qs__WEBPACK_IMPORTED_MODULE_1___default.a.stringify(_this4._params(), { "arrayFormat": "brackets" });
...
var User = function (_BaseModel) {
  ...
  _createClass(User, [{
    ...
    key: "modelClassData",
    value: function modelClassData() {
      return { "attributes": [{ "name": "id", "type": "integer" }, { "name": "email", "type": "string" }, { "name": "created_at", "type": "datetime" }], "name": "User", "pluralName": "users", "relationships": [], "paramKey": "user", "path": "/api_maker/users", "primaryKey": "id" };
    }
  }]);
...
/******/ });
//# sourceMappingURL=application-fc78e3356123684d5244.js.map