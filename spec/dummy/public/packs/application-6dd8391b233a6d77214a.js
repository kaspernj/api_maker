...
/* harmony import */ var _ModelName__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./ModelName */ "./app/javascript/ApiMaker/ModelName.js");
/* harmony import */ var js_money__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! js-money */ "./node_modules/js-money/lib/index.js");
...
var BaseModel = function () {
  _createClass(BaseModel, null, [{
    ...
    value: function modelName() {
      return new _ModelName__WEBPACK_IMPORTED_MODULE_3__["default"]({ modelClassData: this.modelClassData() });
    }
  }, {
    key: "ransack",
    value: function ransack() {
      ...
      return new _Collection__WEBPACK_IMPORTED_MODULE_1__["default"]({ "modelName": this.modelClassData().name, "ransack": query, "targetPathName": this.modelClassData().path });
    }
  }]);
  ...
  _createClass(BaseModel, [{
    ...
    value: function connect(eventName, callback) {
      return App.cable.subscriptions.create({
        ...
        received: function received(json) {
          callback(json);
        }
      });
    }
    ...
    value: function create() {
      ...
      return new Promise(function (resolve, reject) {
        ...
        var modelData = _this2._saveData();
        var dataToUse = {};
    ...
    value: function update() {
      ...
      return new Promise(function (resolve, reject) {
        ...
        _Api__WEBPACK_IMPORTED_MODULE_0__["default"].patch(urlToUse, dataToUse).then(function (response) {
          if (response.success) {
            if (response.model) {
              _this6.modelData = response.model;
              _this6.changes = {};
            }
    ...
    value: function updateRaw(data) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        _Api__WEBPACK_IMPORTED_MODULE_0__["default"].requestLocal({ path: urlToUse, method: "PATCH", rawData: data }).then(function (response) {
          if (response.success) {
            if (response.model) {
              _this7.modelData = response.model;
              _this7.changes = {};
            }
    ...
    value: function isValidOnServer() {
      ...
      return new Promise(function (resolve, reject) {
        ...
        var modelData = _this8._saveData();
        var dataToUse = {};
        dataToUse[paramKey] = modelData;
    ...
    value: function _callmemberCommand(args) {
      return new Promise(function (resolve, reject) {
        ...
        _Api__WEBPACK_IMPORTED_MODULE_0__["default"].post(url, postData).then(function (response) {
          resolve(response);
        }, function (response) {
          reject(response);
        });
    ...
    value: function _getAttributeDateTime(attributeName) {
      ...
      if (!match) match = value.match(/^(\d+)-(\d+)-(\d+)T(\d+):(\d+):(\d+)\.(\d+)\+(\d+):(\d+)$/);

      if (!match) match = value.match(/^(\d+)-(\d+)-(\d+) (\d+):(\d+):(\d+)$/);
    ...
    value: function _getAttributeMoney(attributeName) {
      ...
      return js_money__WEBPACK_IMPORTED_MODULE_4___default.a.fromInteger(cents, currency);
    }
  }, {
    ...
    value: function _loadBelongsToReflection(args) {
      ...
      return new Promise(function (resolve, reject) {
        if (args.reflectionName in _this9.relationshipsCache) {
          resolve(_this9.relationshipsCache[args.reflectionName]);
        } else {
          var collection = new _Collection__WEBPACK_IMPORTED_MODULE_1__["default"](args);
          collection.first().then(function (model) {
            _this9.relationshipsCache[args.reflectionName] = model;
            resolve(model);
          });
        }
      });
      ...
      for (var relationshipName in args.data.relationships) {
        ...
        if (Array.isArray(relationshipData.data)) {
          ...
          for (var relationshipDataIKey in relationshipData.data) {
            ...
            if (!includedData) throw "Couldn't find included data for " + relationshipName;

            var modelClassName = inflection__WEBPACK_IMPORTED_MODULE_2___default.a.classify(inflection__WEBPACK_IMPORTED_MODULE_2___default.a.singularize(includedData.type));
...
/* harmony import */ var _ModelsResponseReader__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ModelsResponseReader */ "./app/javascript/ApiMaker/ModelsResponseReader.js");
/* harmony import */ var qs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! qs */ "./node_modules/qs/lib/index.js");
/* harmony import */ var qs__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(qs__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _Result__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Result */ "./app/javascript/ApiMaker/Result.js");
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
var Collection = function () {
  ...
  _createClass(Collection, [{
    ...
    value: function result() {
      ...
      return new Promise(function (resolve, reject) {
        _this2._response().then(function (response) {
          ...
          var result = new _Result__WEBPACK_IMPORTED_MODULE_3__["default"]({
            "models": models,
            "response": response
          });
          resolve(result);
    ...
    value: function searchKey(_searchKey) {
      this.searchKeyValue = _searchKey;
      return this;
    }
  }, {
    key: "sort",
    ...
    key: "modelClass",
    value: function modelClass() {
      return __webpack_require__("./app/javascript/ApiMaker/Models sync recursive ^\\.\\/.*$")("./" + this.args.modelName).default;
    }
  }, {
    key: "_response",
    value: function _response() {
      ...
      return new Promise(function (resolve, reject) {
        var dataToUse = qs__WEBPACK_IMPORTED_MODULE_2___default.a.stringify(_this4._params(), { "arrayFormat": "brackets" });
        var urlToUse = _this4.args.targetPathName + "?" + dataToUse;
    ...
    value: function _responseToModels(response) {
      var modelsResponseReader = new _ModelsResponseReader__WEBPACK_IMPORTED_MODULE_1__["default"]({ response: response });
    ...
    value: function _params() {
      ...
      if (this.params) params = Object.assign(params, this.params);

      if (this.ransackOptions) params["q"] = this.ransackOptions;
...
var Account = function (_BaseModel) {
  ...
  _createClass(Account, [{
    ...
    value: function projects() {
      var id = this.id();
      return new _Collection__WEBPACK_IMPORTED_MODULE_1__["default"]({ "reflectionName": "projects", "model": this, "modelName": "Project", "targetPathName": "/api_maker/projects", "ransack": { "account_id_eq": id } });
    }
  }, {
    key: "id",
    value: function id() {
...
var Project = function (_BaseModel) {
  ...
  _createClass(Project, [{
    ...
    value: function tasks() {
      var id = this.id();
      return new _Collection__WEBPACK_IMPORTED_MODULE_1__["default"]({ "reflectionName": "tasks", "model": this, "modelName": "Task", "targetPathName": "/api_maker/tasks", "ransack": { "project_id_eq": id } });
    }
  }, {
    key: "id",
    value: function id() {
...
var _class = function (_Controller) {
  ...
  _createClass(_class, [{
    ...
    value: function connect() {
      ...
      ApiMaker_Models_Project__WEBPACK_IMPORTED_MODULE_1__["default"].find(this.element.dataset.projectId).then(function (project) {
        project.loadTask().then(function () {
...
throw new Error("Module build failed (from ./node_modules/babel-loader/lib/index.js):\nSyntaxError: Unexpected token, expected , (8:4)\n\n   6 |     // Test that a found model can be updated and changed\n   7 |     console.log(\"Find project\"\n>  8 |     Project.find(this.element.dataset.projectId).then((project) => {\n     |     ^\n   9 |       console.log(\"Update\")\n  10 |       project.update({name: \"test-update-project\"}).then((data) => {\n  11 |         this.element.dataset.updateCompleted = true\n");
...
/******/ });
//# sourceMappingURL=application-6dd8391b233a6d77214a.js.map