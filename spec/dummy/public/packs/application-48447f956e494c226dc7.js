...
var BaseModel = function () {
  ...
  _createClass(BaseModel, [{
    ...
    value: function _callMemberMethod(args) {
      return new Promise(function (resolve, reject) {
        _Api__WEBPACK_IMPORTED_MODULE_0__["default"].post().then(function (response) {
    ...
    value: function _getAttributeMoney(attributeName) {
      ...
      var money = js_money__WEBPACK_IMPORTED_MODULE_3___default.a.fromInteger(cents, currency);
      return money;
    }
  }, {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Api__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Api */ "./app/javascript/ApiMaker/Api.js");
/* harmony import */ var change_case__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! change-case */ "./node_modules/change-case/change-case.js");
/* harmony import */ var change_case__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(change_case__WEBPACK_IMPORTED_MODULE_1__);
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
    ...
    value: function signIn(username, password) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        _Api__WEBPACK_IMPORTED_MODULE_0__["default"].post("/api_maker/devise/do_sign_in", postData).then(function (response) {
          var apiMakerDataElement = document.querySelector(".api-maker-data");
          var keyName = "current" + change_case__WEBPACK_IMPORTED_MODULE_1___default.a.pascalCase(args.scope);
...
/******/ });
//# sourceMappingURL=application-48447f956e494c226dc7.js.map