...
var _class = function (_Controller) {
  ...
  _createClass(_class, [{
    ...
    value: function onSubmit(e) {
      ...
      ApiMaker_Devise__WEBPACK_IMPORTED_MODULE_1__["default"].signIn(this.emailTarget.value, this.passwordTarget.value, { rememberMe: this.rememberTarget.checked });
      var element = this.element;
      console.log({ element: element }).then(function (response) {
        _this2.element.dataSet["successResponse"] = response;
      }, function (response) {
        _this2.element.dataSet["failResponse"] = response;
      });
    }
  }]);
...
/******/ });
//# sourceMappingURL=application-7656efe59571f5d0668d.js.map