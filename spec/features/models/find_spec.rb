...
describe "model find" do
  ...
  it "finds the model", :js do
    ...
    WaitUtil.wait_for_condition("project element to appear") { puts page.html; puts chrome_logs; find("[data-controller='models--find']", visible: false)["data-find-completed"] == "true" }
